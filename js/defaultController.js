...
bbrmodule.controller('homeController', function ($scope,$http) {  	
loadCommon();
...
bbrmodule.controller('aboutMeController', function ($scope) {
loadCommon();
});

bbrmodule.controller('photographyController', function ($scope) {
   loadCommon();

});


bbrmodule.controller('talkToMeCtrl', function ($scope) {
